export const translations = {
  en: {
    ...
    "projects.0.title": "Boid Flock Simulation",
    "projects.0.desc":
      "A real-time flocking simulation implementing separation, alignment, and cohesion behaviors \u2014 rendered with PixiJS for 60fps performance.",
  ...
  es: {
    ...
    "projects.0.title": "Simulaci\u00f3n de Parvada Boid",
    "projects.0.desc":
      "Una simulaci\u00f3n de parvada en tiempo real que implementa comportamientos de separaci\u00f3n, alineaci\u00f3n y cohesi\u00f3n \u2014 renderizada con PixiJS a 60fps.",
    "projects.1.title": "Sitio Portfolio",
    "projects.1.desc":
